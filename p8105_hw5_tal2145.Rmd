...
Looking at the spaghetti plot where yellow represents the experimental arm and purple represents the control arm, we see that the values of weekly observation for the experimental subjects is higher on average than that of the control arm. 
